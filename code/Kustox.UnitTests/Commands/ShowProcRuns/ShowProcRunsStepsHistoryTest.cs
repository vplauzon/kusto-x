...
{
    public class ShowProcRunsStepsHistoryTest
    {
        [Fact]
        public void Vanila()
        {
            var script = @".show procedure runs 'abc' steps [1,2,3] history";
        ...
        {
            var script = @".show procedure runs 'don' steps [1,2,3] history | project A='def'";
            var statement = new KustoxCompiler().CompileStatement(script);
